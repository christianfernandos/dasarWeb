<?php
// menambahkan daftar nilai siswa yang lulus
...
// menambahkan daftar karyawan dengan pengalaman kerja lebih dari 5 tahun
$daftarKaryawan = [
    ["Alice", 7],
    ["Bob", 3],
    ["Charlie", 9],
...
// menambahkan daftar nilai mahasiswa dalam mata kuliah tertentu
$daftarNilai = [
    'Matematika' => [
        ["Alice", 85],
        ["Bob", 92],
...
echo "<br><br>";
 ...
 // SOal Ceita untuk menambahkan siswa yang mendapatkan nilai di atas rerata
$daftarNilaiSiswa = [
    ['Alice', 85],
    ['Bob', 92],
    ['Charlie', 78],
